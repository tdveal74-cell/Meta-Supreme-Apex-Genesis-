...
* **No ffmpeg exists in this container.** Every test above pins an argv and a
  ...
  the unit tests read.
* **Where it should live.** The autonomy driver names EDITFORGE-HOST, the EditForge
  box, or its own host. EDITFORGE-HOST's public address is not recorded in this
...
Deployed to `N8N-HOST` (`N8N-HOST-IP`, Ubuntu 24.04.4 LTS, 2 cores, 7.8 GiB),
bound to `BRIDGE-GATEWAY:8080`, the `n8n_backend` docker bridge gateway. The three
