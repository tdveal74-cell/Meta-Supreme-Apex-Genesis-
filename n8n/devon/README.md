...
this repository: there is no n8n credential in CI. What the two tests below pin
...
These are the Code node bodies of four workflows plus the Spine's two. The
