...
| Weekly Table Backup workflow | `qCfGZ1CwmpK9vOta` | Sundays 03:10 UTC; read-only export of the four learning-lane tables to CSV, one email with four attachments; approval_queue EXCLUDED on purpose (plaintext decision tokens — mailing them would let inbox access approve soul writes) |
