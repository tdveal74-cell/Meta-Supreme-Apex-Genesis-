...
KEY_ROTATION = (
    ...
    "After rotating, prove it two ways. Post one capture from the phone and read "
    "the reply, where a 401 means an outside holder was missed. Then file one "
    "level 0 job with blast radius none and auto_verify, which completes without a "
    "card and makes every organ perform a real authenticated call: a pass reading "
    "ledger_clean true on every hop is the proof the internal cutover is whole. "
    "Rotated 2026-09-06 and proven that way by job 01M1TB5RAJHF0FJEN91QMKYYK7, "
    "which ran RECEIVED to COMPLETED in one pass of six steps, the Action Router "
    "dispatching to the Spine on execution 6069, every hop clean. "
