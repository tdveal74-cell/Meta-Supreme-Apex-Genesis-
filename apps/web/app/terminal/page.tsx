        ...
        <header className="mb-4 flex flex-col gap-4 rounded-2xl border border-white/10 bg-white/[0.035] px-5 py-4 backdrop-blur md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-4">
            <div className="relative flex h-11 w-11 items-center justify-center rounded-xl border border-amber-400/30 bg-amber-400/10">
              ...
              <span className={`absolute -right-1 -top-1 h-2.5 w-2.5 rounded-full ${ready ? "bg-emerald-400" : "bg-amber-400"}`} />
            </div>
            <div>
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs text-white/55">
            <span className="rounded-full border border-white/10 bg-black/30 px-3 py-1.5">{statusLabel}</span>
            <span className="rounded-full border border-white/10 bg-black/30 px-3 py-1.5">Human final</span>
            <Link href="/" className="rounded-lg border border-white/10 px-3 py-2 font-medium text-white/70 transition hover:border-white/20 hover:text-white">
              Command Center
            </Link>
          </div>
        </header>
